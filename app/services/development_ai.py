...
SALES_RULES = '''Съёмка бесплатная; выбранный кадр стоит 500 ₽ в Гранде, 300 ₽ в Элладе и 400 ₽ в остальных отелях. Гость может купить отдельные фотографии или всю съёмку со скидкой до 50%, которую определяет фотограф. Цена отдельного кадра остаётся базовой для его отеля. Слайд-шоу показывают при выборе, отдельно не продают; его включение можно обсуждать при переговорах. Нельзя давить на гостя, придумывать дефицит, обещать неподтверждённую скидку или скрывать цену. Менеджер объясняет условия до записи. Оплата считается подтверждённой после сверки владельцем; фото чека само по себе её не доказывает.'''
SALES_SCENARIOS = [
 ...
 {'type':'discount','title':'Просьба о большой скидке','opening':'Продайте мне по 200 рублей за фотографию, иначе ничего не возьму.','advice':'Сохраните базовую цену отдельного кадра для отеля: Гранд 500 ₽, Эллада 300 ₽, остальные 400 ₽. Обсудите скидку до 50% только на всю съёмку.'},
]
